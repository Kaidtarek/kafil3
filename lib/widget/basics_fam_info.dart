                                        ...
                                        if (selectedFamilies[familyId] ==
                                          ...
                                          showDialog(
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog(
                                                title: Icon(
                                                  Icons.volunteer_activism_rounded,size: 50,
                                                  color: Colors.green,
                                                ),
                                                content:
                                                    Text("تمت الاضافة بنجاح",textAlign: TextAlign.center,style: TextStyle(fontSize: 35,fontWeight: FontWeight.bold,color: Color.fromARGB(255, 51, 73, 70)),),
                                                actions: [
                                                  ElevatedButton(
                                                    child: Text("OK"),
                                                    onPressed: () {
